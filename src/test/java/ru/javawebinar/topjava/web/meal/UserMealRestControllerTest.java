...
public class UserMealRestControllerTest extends AbstractControllerTest {
    ...
    public void testGet() throws Exception {
        mockMvc.perform(get(REST_URL + MEAL1_ID).with(TestUtil.userHttpBasic(USER)))
    ...
    public void testDelete() throws Exception {
        mockMvc.perform(delete(REST_URL + MEAL1_ID).contentType(MediaType.APPLICATION_JSON).with(TestUtil.userHttpBasic(USER)))
                .andExpect(status().isOk());
    ...
    public void testUpdate() throws Exception {
        ...
        mockMvc.perform(put(REST_URL + MEAL1_ID).contentType(MediaType.APPLICATION_JSON).with(TestUtil.userHttpBasic(USER))
    ...
    public void testGetBetween() throws Exception {
        mockMvc.perform(get(REST_URL + "between?startDateTime=2015-05-30T07:00&endDateTime=2015-05-31T11:00:00").with(TestUtil.userHttpBasic(USER)))
                .andExpect(status().isOk())
                .andDo(print())
    ...
    public void testFilter() throws Exception {
        mockMvc.perform(get(REST_URL + "filter?startDate=2015-05-30&startTime=07:00&endDate=2015-05-31&endTime=11:00").with(TestUtil.userHttpBasic(USER)))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(MATCHER_WITH_EXCEED.contentListMatcher(
                        UserMealsUtil.createWithExceed(MEAL4, true),
    ...
    public void testFilterAll() throws Exception {
        mockMvc.perform(get(REST_URL + "filter?startDate=&endTime=").with(TestUtil.userHttpBasic(USER)))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(MATCHER_WITH_EXCEED.contentListMatcher(
