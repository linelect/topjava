...
public class JacksonObjectMapper extends ObjectMapper {
    ...
    private JacksonObjectMapper() {
        ...
        simpleModule.addSerializer(new JsonLocalDateTimeConverter.LocalDateTimeSerializer());
        simpleModule.addDeserializer(LocalDateTime.class, new JsonLocalDateTimeConverter.LocalDateTimeDeserializer());
